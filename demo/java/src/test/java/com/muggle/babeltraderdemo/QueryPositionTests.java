...
@SpringBootTest
public class QueryPositionTests {
    ...
    private void TestQueryPosition_CTP() throws Exception {
    ...
    private void TestQueryPosition_XTP() throws Exception {
    ...
    public void TestQueryPosition() throws Exception {
        TestQueryPosition_CTP();
//        TestQueryPosition_XTP();
